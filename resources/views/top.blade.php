...
<section class="bg-gray-100">
  ...
  <div class="container mx-auto py-40 relative">
    <h2 class="mt-1 font-bold font-heading text-center text-3xl">リスト一覧</h2>
    ...
    <a href="/plans/" class="inline-block text-xs text-white font-semibold leading-none rounded py-4 text-blue-500 border-solid bg-white border-blue-500 border-2 px-16 hover:text-white hover:bg-blue-500">リストを作成する</a>
  </div>
  </div>
</section>
